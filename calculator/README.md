...
Keyboard Support: Users can perform calculations using both on-screen buttons and their physical keyboard.

Responsive UI: Optimized for all screen sizes, featuring a modern dark-themed aesthetic that matches my Galaxy Portfolio.
